...
const vicidialUploader = {
    ...
    testConnection: async function() {
        try {
            const API_URL = window.location.hostname === 'localhost' ? 'http://localhost:8897' : window.location.hostname.includes('github.io') ? 'https://stars-blocking-molecules-ones.trycloudflare.com' : 'http://192.168.40.232:8897';
