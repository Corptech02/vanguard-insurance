...
const vicidialUploader = {
    ...
    testConnection: async function() {
        try {
            const API_URL = window.location.hostname === 'localhost' ? 'http://localhost:8897' : window.location.hostname.includes('github.io') ? 'https://public-suits-count.loca.lt' : 'http://192.168.40.232:8897';
